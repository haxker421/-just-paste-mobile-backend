...
# Read DATABASE_URL (Railway Postgres) or fall back to SQLite in-container
DB_URL = os.environ.get("DATABASE_URL", "sqlite:///downloads.db")
...
def download_get():
    ...
    try:
        ...
        return send_file(path, as_attachment=True, download_name=f"JustPaste.{fmt}")
    except Exception as e:
